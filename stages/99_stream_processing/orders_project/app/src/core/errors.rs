...
impl Display for AppError {
    fn fmt(&self, f: &mut Formatter<'_>) -> FmtResult {
        let msg = match self {
            ...
            Self::ThreadLockError(t) => t.to_string(),
            Self::ParseHeaderError(t) => t.to_string(),
...
impl ResponseError for AppError {
    fn status_code(&self) -> StatusCode {
        match self {
            ...
            Self::ThreadLockError(_) => StatusCode::INTERNAL_SERVER_ERROR,
            Self::ParseHeaderError(_) => StatusCode::BAD_REQUEST,
